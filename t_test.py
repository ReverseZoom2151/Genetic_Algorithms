...
def t_test(data1, data2):
    ...
    # calculate mean, standard deviation (stdev) and standard error (sterr) of each sample
    ...
    # calculate the standard error for the difference between the sample means (sterrdm)
    sterrdm = math.sqrt(sterr1 * sterr1 + sterr2 * sterr2)

    # calculate the "t" statistic
    t = (mean1 - mean2) / sterrdm

    # calculate the "degrees of freedom" ("df") = (n1 - 1) + (n2 - 1)
